...
db:
	DB_URL="jdbc:postgresql://localhost:${DB_PORT}/${DB_NAME}" DB_USER=${DB_PASS} DB_PASS=${DB_PASS} \
...
db_dev:
	DB_URL="jdbc:postgresql://localhost:5432/db1" DB_USER=${DB_PASS} DB_PASS=${DB_PASS} \
